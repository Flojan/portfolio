<template>
  <div class="projects overflow-x-hidden h-screen w-full">
    ...
    <div class="flex space-x-4 scroll">
      ...
      >
        <div class="max-w-xl">
          ...
          <a
            ...
            href="https://github.com/Flojan/portfolio"
            target="_blank"
      ...
      >
        <div class="max-w-xl">
          ...
          <a
            class="button underline-effect py-5 text-xl z-0"
            href="https://github.com/Flojan/Foodega"
            target="_blank"
            rel="noopener noreferrer"
            >zum Projekt
            <svg
      ...
      >
        <div class="max-w-xl">
          ...
          <a
            class="button underline-effect py-5 text-xl z-0"
            href="https://rebekka-schoenefuss.de/"
            target="_blank"
            rel="noopener noreferrer"
            >zum Projekt
            <svg
      ...
      >
        <div class="max-w-xl">
          ...
          <a
            class="button underline-effect py-5 text-xl z-0"
            href="https://github.com/Flojan/Corona-Inc"
            target="_blank"
            rel="noopener noreferrer"
            >zum Projekt
            <svg
      ...
      >
        <div class="max-w-xl">
          ...
          <a
            class="button underline-effect py-5 text-xl z-0"
            href="https://i-tuepfelchen-2002.de/"
            target="_blank"
            rel="noopener noreferrer"
            >zum Projekt
            <svg
      ...
      >
        <div class="max-w-xl">
          ...
          <a class="button underline-effect py-5 text-xl z-0"
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-7 w-7 inline-block mb-1"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
